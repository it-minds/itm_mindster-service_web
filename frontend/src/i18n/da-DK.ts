...
export const table: Locale = {
  ...
  applicationScreen: {
    infoBoxes: {
      createTokenInfo: `(DANISH)Here you can create your AppToken for your application. First you must write a name for your App Token that should 
      ...
      BrowseTokenInfo: `(DANISH)This is the service library. Here you can see all the available services and their actions.
      ...
      SeeTokenStatusInfo: `(DANISH)Here you can see what actions your token contains. Next to each actions is a symbol showing if
